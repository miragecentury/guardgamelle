...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'acme.twig.extension' => 'getAcme_Twig_ExtensionService',
            ...
            'doctrine.dbal.google_connection' => 'getDoctrine_Dbal_GoogleConnectionService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.default' => 'getDoctrine_Dbal_Logger_Profiling_DefaultService',
            'doctrine.dbal.logger.profiling.google' => 'getDoctrine_Dbal_Logger_Profiling_GoogleService',
            'doctrine.orm.default_entity_manager' => 'getDoctrine_Orm_DefaultEntityManagerService',
            'doctrine.orm.default_manager_configurator' => 'getDoctrine_Orm_DefaultManagerConfiguratorService',
            'doctrine.orm.google_entity_manager' => 'getDoctrine_Orm_GoogleEntityManagerService',
            'doctrine.orm.google_manager_configurator' => 'getDoctrine_Orm_GoogleManagerConfiguratorService',
            ...
            'security.firewall.map.context.inscription' => 'getSecurity_Firewall_Map_Context_InscriptionService',
    ...
    /**
     * Gets the 'acme.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Acme\PageBundle\Twig\Extension\AcmePageExtension A Acme\PageBundle\Twig\Extension\AcmePageExtension instance.
     */
    protected function getAcme_Twig_ExtensionService()
    {
        return $this->services['acme.twig.extension'] = new \Acme\PageBundle\Twig\Extension\AcmePageExtension($this->get('request'));
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/zeus/Sites/guardgamelle/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/zeus/Sites/guardgamelle/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/zeus/Sites/guardgamelle/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/zeus/Sites/guardgamelle/app/Resources');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection', 'google' => 'doctrine.dbal.google_connection'), array('default' => 'doctrine.orm.default_entity_manager', 'google' => 'doctrine.orm.google_entity_manager'), 'default', 'default');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'guardgamelle', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'degrasse', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }

    /**
     * Gets the 'doctrine.dbal.google_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return stdClass A stdClass instance.
     */
    protected function getDoctrine_Dbal_GoogleConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.google'));
        ...
        return $this->services['doctrine.dbal.google_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'guardgamelle', 'host' => '173.194.106.53', 'port' => NULL, 'user' => 'root', 'password' => 'gu4rdg4m3l', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_7b70a1aeaaf441233ceed969319e30b5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7b70a1aeaaf441233ceed969319e30b5');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_7b70a1aeaaf441233ceed969319e30b5');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/home/zeus/Sites/guardgamelle/src/Guard/Common/AnimalBundle/Entity', 1 => '/home/zeus/Sites/guardgamelle/src/Guard/Common/UserBundle/Entity', 2 => '/home/zeus/Sites/guardgamelle/src/Guard/Common/GamelleBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Guard\\Common\\AnimalBundle\\Entity');
        $f->addDriver($e, 'Guard\\Common\\UserBundle\\Entity');
        $f->addDriver($e, 'Guard\\Common\\GamelleBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('/home/zeus/Sites/guardgamelle/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine/model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('GuardCommonAnimalBundle' => 'Guard\\Common\\AnimalBundle\\Entity', 'GuardCommonUserBundle' => 'Guard\\Common\\UserBundle\\Entity', 'GuardCommonGamelleBundle' => 'Guard\\Common\\GamelleBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/home/zeus/Sites/guardgamelle/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'doctrine.orm.google_entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Doctrine\ORM\EntityManager A Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_GoogleEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_google_7b70a1aeaaf441233ceed969319e30b5');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_google_7b70a1aeaaf441233ceed969319e30b5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_google_7b70a1aeaaf441233ceed969319e30b5');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/zeus/Sites/guardgamelle/src/Guard/Common/EventBundle/Entity')), 'Guard\\Common\\EventBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('GuardCommonEventBundle' => 'Guard\\Common\\EventBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/zeus/Sites/guardgamelle/app/cache/dev/doctrine/orm/Proxies');
        ...
        $this->services['doctrine.orm.google_entity_manager'] = $instance = call_user_func(array('Doctrine\\ORM\\EntityManager', 'create'), $this->get('doctrine.dbal.google_connection'), $e);

        $this->get('doctrine.orm.google_manager_configurator')->configure($instance);

        return $instance;
    }

    /**
     * Gets the 'doctrine.orm.google_manager_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Doctrine\Bundle\DoctrineBundle\ManagerConfigurator A Doctrine\Bundle\DoctrineBundle\ManagerConfigurator instance.
     */
    protected function getDoctrine_Orm_GoogleManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.google_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/zeus/Sites/guardgamelle/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'f9ac59ee5fbf4688678d921ce98a1d1a3ad9489b');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Guard\\Common\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Guard\\Common\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Guard\\Common\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Guard\\Common\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Guard\\Common\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/zeus/Sites/guardgamelle/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('google', $this->get('doctrine.dbal.logger.profiling.google'));

        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/zeus/Sites/guardgamelle/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/zeus/Sites/guardgamelle/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/zeus/Sites/guardgamelle/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Guard\\Common\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/v1/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.inscription' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/inscription$'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'))), $this->get('event_dispatcher'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.inscription' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_InscriptionService()
    {
        return $this->services['security.firewall.map.context.inscription'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(race|animal|gamelle)');
        ...
        $k = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'f9ac59ee5fbf4688678d921ce98a1d1a3ad9489b', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $l = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, 'guard_common_user_login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        $l->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $l->addHandler($k);

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($j, array('login_path' => 'guard_common_user_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $m->setProviderKey('main');

        $n = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $j, 'main', $m, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $j, array('login_path' => 'guard_common_user_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d);
        $n->setRememberMeServices($k);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $l, 3 => $n, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $k, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '527c114a1c755', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, 'guard_common_user_login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/zeus/Sites/guardgamelle/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/zeus/Sites/guardgamelle/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/zeus/Sites/guardgamelle/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/zeus/Sites/guardgamelle/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/zeus/Sites/guardgamelle/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/zeus/Sites/guardgamelle/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/zeus/Sites/guardgamelle/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/zeus/Sites/guardgamelle/app', 'UTF-8'));
        ...
        $instance->addExtension($this->get('acme.twig.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/PublicBundle/Resources/views', 'GuardCommonPublic');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/UserBundle/Resources/views', 'GuardCommonUser');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Api/v1Bundle/Resources/views', 'GuardApiv1');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/AnimalBundle/Resources/views', 'GuardCommonAnimal');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/GamelleBundle/Resources/views', 'GuardCommonGamelle');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/BalanceBundle/Resources/views', 'GuardCommonBalance');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/EventBundle/Resources/views', 'GuardCommonEvent');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Guard/Common/HealthBundle/Resources/views', 'GuardCommonHealth');
        $instance->addPath('/home/zeus/Sites/guardgamelle/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/zeus/Sites/guardgamelle/app/Resources/views');
        $instance->addPath('/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f9ac59ee5fbf4688678d921ce98a1d1a3ad9489b');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/zeus/Sites/guardgamelle/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/zeus/Sites/guardgamelle/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.google' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_GoogleService()
    {
        return $this->services['doctrine.dbal.logger.profiling.google'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username_email'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'f9ac59ee5fbf4688678d921ce98a1d1a3ad9489b', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('527c114a1c755')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/zeus/Sites/guardgamelle/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/home/zeus/Sites/guardgamelle/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml', 2 => '/home/zeus/Sites/guardgamelle/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/zeus/Sites/guardgamelle/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/zeus/Sites/guardgamelle/app/cache/dev',
            'kernel.logs_dir' => '/home/zeus/Sites/guardgamelle/app/logs',
            'kernel.bundles' => array(
                ...
                'GuardCommonPublicBundle' => 'Guard\\Common\\PublicBundle\\GuardCommonPublicBundle',
                'GuardCommonUserBundle' => 'Guard\\Common\\UserBundle\\GuardCommonUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'GuardApiv1Bundle' => 'Guard\\Api\\v1Bundle\\GuardApiv1Bundle',
                'GuardCommonAnimalBundle' => 'Guard\\Common\\AnimalBundle\\GuardCommonAnimalBundle',
                'GuardCommonGamelleBundle' => 'Guard\\Common\\GamelleBundle\\GuardCommonGamelleBundle',
                'GuardCommonBalanceBundle' => 'Guard\\Common\\BalanceBundle\\GuardCommonBalanceBundle',
                'GuardCommonEventBundle' => 'Guard\\Common\\EventBundle\\GuardCommonEventBundle',
                'GuardCommonHealthBundle' => 'Guard\\Common\\HealthBundle\\GuardCommonHealthBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'guardgamelle',
            'database_user' => 'root',
            'database_password' => 'degrasse',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'fr',
            'secret' => 'f9ac59ee5fbf4688678d921ce98a1d1a3ad9489b',
            'database_path' => NULL,
            ...
            'debug.container.dump' => '/home/zeus/Sites/guardgamelle/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'f9ac59ee5fbf4688678d921ce98a1d1a3ad9489b',
            ...
            'session.save_path' => '/home/zeus/Sites/guardgamelle/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/zeus/Sites/guardgamelle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/home/zeus/Sites/guardgamelle/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation.xml',
                2 => '/home/zeus/Sites/guardgamelle/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/validation/orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/zeus/Sites/guardgamelle/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/zeus/Sites/guardgamelle/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/zeus/Sites/guardgamelle/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/zeus/Sites/guardgamelle/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/zeus/Sites/guardgamelle/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/zeus/Sites/guardgamelle/app/../web',
            'assetic.write_to' => '/home/zeus/Sites/guardgamelle/app/../web',
            ...
            'doctrine.entity_managers' => array(
                ...
                'google' => 'doctrine.orm.google_entity_manager',
            ),
            ...
            'doctrine.connections' => array(
                ...
                'google' => 'doctrine.dbal.google_connection',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/home/zeus/Sites/guardgamelle/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_user.model.user.class' => 'Guard\\Common\\UserBundle\\Entity\\User',
